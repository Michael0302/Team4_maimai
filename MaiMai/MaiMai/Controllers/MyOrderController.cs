...
namespace MaiMai.Controllers
{
    ...
    public class MyOrderController : Controller
    {
        ...
        {
            var reportDetail = db.Report.Select(t => new
            {
        ...
        public ActionResult saveReport(string? reportTXT)
        {
            var isActive = db.Report.FirstOrDefault(x => x.tagName == TagName);
            if (isActive != null)
            {
            ...
            Report r = new Report
            {
                ...
                ReprotDetail.reason=form.reason
            };
